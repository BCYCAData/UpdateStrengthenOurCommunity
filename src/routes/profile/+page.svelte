...
<h2 class="mx-2 sm:text-lg">Prepare Connect Rebound</h2>
<p class="mx-3 my-1 sm:text-lg">
	The project evolved from feedback provided by the community following the 2019 bushfires and is
	funded through the state and federal Bushfire Community Resilience Recovery Fund.
</p>
<p class="mx-3 my-1 sm:text-lg">
	The answers you provide in these pages will provide an accurate image of our community,
	identifying areas of strength and also areas that need additional support.
</p>
<p class="mx-3 my-1 sm:text-lg">
	This information is confidential and will be owned and updated by you.
</p>
<p class="mx-3 my-1 sm:text-lg">
	Please check each menu item and make sure there are answers for all the questions on each page.
</p>
<p class="mx-3 my-1 sm:text-lg">
	The information you have provided will be used to create a digital "map" of the area providing
	information which could be useful to emergency responders in time of need.
</p>
<p class="mx-3 my-1 sm:text-lg">
